...
def createReceipt(doc):
    ...
    drawhead.text((width/2,120), type, anchor="ml", font=textfont, fill=0)
...
# Print Settings
width = 400
titlefont = ImageFont.truetype('ZenKakuGothicNew-Medium.ttf', 32, encoding='unic')
largefont = ImageFont.truetype('ZenKakuGothicNew-Medium.ttf', 20, encoding='unic') # 合計金額
numberfont = ImageFont.truetype('ZenKakuGothicNew-Medium.ttf', 16, encoding='unic')
textfont = ImageFont.truetype('ZenKakuGothicNew-Regular.ttf', 16, encoding='unic')
